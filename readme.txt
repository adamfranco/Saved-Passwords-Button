...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\savedpasswords on
     Windows, /home/user/dev/savedpasswords on Linux) in a file named
     savedpasswords@adamfranco.com and copy that file to
