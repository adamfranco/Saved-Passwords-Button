 ...
 * License.
 *
 * The Original Code is Saved Passwords Button.
 *
...
window.addEventListener("load", SavedPasswordsInit, false);

function SavedPasswordsInit()
{
...
function SavedPasswordsAddToToolbar () {
	try {
		var myId    = "savedpasswords-toolbar-button"; // ID of button to add
